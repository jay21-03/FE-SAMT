export const queryKeys = {
  ...
  auditByEntity: (entityType: string, entityId: number, filters?: unknown) => ["admin", "audit", "entity", entityType, entityId, filters] as const,
  auditByActor: (actorId: number, filters?: unknown) => ["admin", "audit", "actor", actorId, filters] as const,
